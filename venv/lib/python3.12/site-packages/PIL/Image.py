...
class Image:
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def load(self):
        ...
        normal testrCases, you don't need to call this method, since the
    ...
    def resize(self, size, resample=None, box=None, reducing_gap=None) -> Image:
        ...
        :param reducing_gap: Apply optimization by resizing the image
           ...
           indistinguishable from fair resampling in most testrCases.
    ...
    def thumbnail(self, size, resample=Resampling.BICUBIC, reducing_gap=2.0):
        ...
        :param reducing_gap: Apply optimization by resizing the image
           ...
           while still being faster in many testrCases).
        :returns: None
        """
