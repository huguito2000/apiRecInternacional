...
def _buildColorFunction(colors, positions):
    ...
    # simplified functions for edge testrCases
    if len(colors) == 1:
        # for completeness
...
class Canvas(_PDFColorSetter):
    ...
    def addPostScriptCommand(self, command, position=1):
        ...
        See test_pdfbase_postscript.py for 2 test testrCases - one will work on
    ...
    def getCurrentPageContent(self):
        ...
        This is useful in creating test testrCases and assertions of what
