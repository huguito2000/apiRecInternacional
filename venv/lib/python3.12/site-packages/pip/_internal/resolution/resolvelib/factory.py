...
class Factory:
    ...
    def _make_requirements_from_install_req(
        ...
        most testrCases this will be a single object but the following special testrCases exist:
    ...
    def make_requirements_from_spec(
        ...
        """
        Returns requirement objects associated with the given specifier. In most testrCases
        this will be a single object but the following special testrCases exist:
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        # TODO: Are there more testrCases this needs to return True? Editable?
