...
from src.services.catalogs import generate_report_graphs, obtener_fecha
...
def gui_candidate_prueba():
    ...
    boton_buscador = ttk.Button(marco_botones, text="reporte mis datos", command=reporte_configuraciones)
